package com.multiplayer.services.yandexauth
...
import com.multiplayer.core.domain.yandexauth.YandexAuthorizationRequest
...
internal class YandexAuthRepositoryImpl(
    ...
    private fun com.multiplayer.services.yandexauth.internal.OAuthTokenPayload.toSession(
        userIdentity: YandexUserIdentity,
        deviceId: com.multiplayer.core.domain.yandexauth.YandexDeviceId,
    ): YandexAuthSession {
    ...
    private fun com.multiplayer.services.yandexauth.internal.ParsedAuthorizationCallback.throwIfProviderError() {
    ...
    private fun com.multiplayer.services.yandexauth.internal.ParsedAuthorizationCallback.requireAuthorizationCode():
        String {
        return code ?: throw YandexAuthException.MissingAuthorizationCode
    }

    private fun com.multiplayer.services.yandexauth.internal.ParsedAuthorizationCallback.requireMatchingState(
