...
Макет приветственного экрана iOS: название приложения, слоган и блок входа через Яндекс Музыку (OAuth / Yandex ID).

![Макет приветственного экрана MultiPlayer для iOS с блоком входа через Яндекс Музыку](./docs/design/ios-welcome-screen-mockup.png)
